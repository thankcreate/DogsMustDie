...
void Stage3_04Layer::initPlanets()
{
	...
	makePlanet(kForceSideThird, ccp(243, 56), 12, 1);



	makePlanet(kForceSideDog, ccp(619, 365), 20, 3);
	makePlanet(kForceSideDog, ccp(619, 229), 20, 3);
	makePlanet(kForceSideThird, ccp(452, 365), 10, 3);
